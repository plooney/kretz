...
int main(int ,char *[] )
{
    ...
    ITKImageWriter->SetFileName("testImageCartesian.nii.gz");
    ...
    ITKImageWriter->SetFileName("testImageToroidal.nii.gz");
    ...
    ITKImageWriter->SetFileName("testImageCartesian2.nii.gz");
